...
/// <summary>
/// Linux implementation of <see cref="ICursorAgentRunner"/>.
/// Resolves the Cursor Agent path from .env (CURSOR_AGENT_PATH), then environment variable, then PATH ("agent").
/// </summary>
public sealed class CursorAgentRunnerLinux : ICursorAgentRunner
{
    /// <inheritdoc />
