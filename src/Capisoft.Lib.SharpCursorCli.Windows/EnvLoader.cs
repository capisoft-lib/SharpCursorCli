...
/// <summary>
/// Minimal .env file loader. Reads KEY=value lines; skips empty and # comments.
...
internal static class EnvLoader
{
    ...
    /// <summary>
    /// Loads variables from .env files (current directory, then parent directories up to a few levels).
    /// Returns the first value found for the given key, or null.
    /// </summary>
    ...
    /// <summary>Gets CURSOR_AGENT_PATH from .env, then from environment variable, then null (caller may use PATH).</summary>
