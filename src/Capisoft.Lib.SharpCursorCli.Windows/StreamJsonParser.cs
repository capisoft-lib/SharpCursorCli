...
/// <summary>
/// Parses NDJSON lines from the CLI stream-json output into StreamEvent records.
/// </summary>
internal static class StreamJsonParser
{
    ...
    /// <summary>Parse final JSON result (single object) for RunAsync with OutputFormat.Json.</summary>
