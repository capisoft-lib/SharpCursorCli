...
/// <summary>
/// Builds ProcessStartInfo.ArgumentList from AgentChatOptions. Uses ArgumentList only (no manual escaping).
/// </summary>
internal static class ArgumentBuilder
{
    /// <summary>Builds only the agent CLI arguments (--print, --output-format, prompt, etc.). Caller prepends base args (e.g. -File script.ps1).</summary>
